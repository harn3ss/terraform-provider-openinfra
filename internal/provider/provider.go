...
var crdKinds = []struct{ typeName, plural, kind string }{
	...
	{"identity_provider", "identityproviders", "IdentityProvider"},
	...
	{"nat_gateway", "natgateways", "NatGateway"},
	{"elastic_ip", "elasticips", "ElasticIp"},
	{"transit_gateway", "transitgateways", "TransitGateway"},
	{"flow_log", "flowlogs", "FlowLog"},
